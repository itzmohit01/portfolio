...
const socials = [
  { name: 'GitHub', url: 'https://github.com/Bhanu-partap-13', icon: (
  ...
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/bhanu-partap-a49084274/', icon: (
  ...
  { name: 'Twitter', url: 'https://x.com/bhanupartap59', icon: (
